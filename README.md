...
1. Terdapat beberapa *web-hosting provider* yang menyediakan *script* instalasi **Dolibarr** otomatis, seperti [SimpleScripts](http://www.simplescripts.com/script_details/install:PrestaShop), [Installatron](https://installatron.com/apps?q=dolibarr), atau [Softaculous](http://www.softaculous.com/apps/ecommerce/PrestaShop).
